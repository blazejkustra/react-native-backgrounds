...
import CircularGradientMultiLayerScreen from './screens/CircularGradient/CircularGradientMultiLayerScreen';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        />
        <Stack.Screen
          name="CircularGradientMultiLayer"
          component={CircularGradientMultiLayerScreen}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
